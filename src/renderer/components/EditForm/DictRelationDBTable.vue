<template>
  <div>
    <DictRelationDBTableEdit :editObject="editObject" :visible="editVisible" formLabelWidth="10rem" @editclosing="setEditVisible"></DictRelationDBTableEdit>
...
<script>
import DictRelationDBTableEdit from './DictRelationDBTableEdit.vue'
export default {
  components: {
    DictRelationDBTableEdit
  },
  data () {
    return {
      tableObject: {},
