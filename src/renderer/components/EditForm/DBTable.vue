<template>
  <div>
    <DBTableEdit :editObject="editObject" :visible="editVisible" formLabelWidth="10rem" @editclosing="setEditVisible"></DBTableEdit>
...
<script>
import DBTableEdit from './DBTableEdit.vue'
export default {
  components: {
    DBTableEdit
  },
